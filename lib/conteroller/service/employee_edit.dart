...
class EmployeeEditService {
  static Future<bool> service({required Map<String, dynamic> data,required int id}) async {
    try {
      var token = await LocalStorage().getData(key: "token");
      Uri uri = Uri.parse(ApiUrls.editEmployeeUrl + "/$id");
      var header = {
      ...
      if (res.statusCode == 200) {
        log("========Success=============");
        //Get.snackbar("Success", "Successfully Edited");
        return true;
